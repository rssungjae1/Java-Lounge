...
<body>
	...
	out.println("selected");%>>기타</option>
				...
				<option value="추천순" <%if (lectureDivide.equals("추천순"))
	out.println("selected");%>>추천순</option>
			</select> <span> <input type="text" name="search" class="form-control mx-1 mt-2" placeholder="내용을 입력하세요.">
			</span>
			<button type="submit" class="btn btn-primary mx-1 mt-2">검색</button>
			<a class="btn btn-primary mx-1 mt-2" data-toggle="modal" href="#registerModal">등록하기</a> <a class="btn btn-danger mx-1 mt-2" data-toggle="modal" href="#reportModal">신고</a>
		</form>
		<%
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					<%=evaluation.getEvaluationTitle()%>&nbsp;<span><%=evaluation.getLectureYear()%>년 <%=evaluation.getSemesterDivide()%></span>
				</h5>
		...
		<li class="page-item">
			...
			%> <a class="page-link disabled">이전</a> <%
			 ...
			 %> <a class="page-link" href="./index.jsp?lectureDivide=<%=URLEncoder.encode(lectureDivide, "UTF-8")%>&searchType=
						<%=URLEncoder.encode(searchType, "UTF-8")%>&search=<%=URLEncoder.encode(search, "UTF8")%>&pageNumber=
						<%=pageNumber - 1%>">이전</a> <%
			 	}
			 %>
		</li>
	...
	<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labeldby="modal" aria-hidden="true">
					...
					<form action="./evaluationRegisterAction.jsp" method="post">
						...
						<div class="form-row">
							<div class="form-group col-sm-4">
								<label>수강 연도</label> <select name="lectureYear" class="form-control">
	...
	<div class="modal fade" id="reportModal" tabindex="-1" role="dialog" aria-labeldby="modal" aria-hidden="true">
		<div class="modal-dialog" style="background-color: white;">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form action="./reportAction.jsp" method="post">
						...
						<div class="form-group">
							<label>신고 제목</label> <input type="text" name="reportTitle" class="form-control" maxlength="20">
						</div>
						<div class="form-group">
							<label>신고 내용</label>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">추가하기</button>
